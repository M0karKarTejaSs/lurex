...
$pdata = mysqli_query($con, "select * from products where c_id = $c_id");
$rowDo = mysqli_fetch_assoc($pdata);

$description = $rowDo['description'];
                        ...
                        <li class="menu-item-has-children"><a href="product.php">Products</a>
                            <ul class="sub-menu">
                                ...
                                ?>
                                        ...
                                        <li><a href="commonfile.php"><?php echo $name; ?></a></li>
                                <?php }
                                }
                                ?>
