...
$pdata = mysqli_query($con, "select * from products where id = $c_id");
        ...
        <div class="nav-container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <?php if (mysqli_num_rows($pdata) > 0) : ?>

                            <?php while ($rowDo = mysqli_fetch_array($pdata)) : ?>

                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="product-single-item">
                                        <div class="product-img">
                                            <img src="<?php echo $rowDo['prod_image']; ?>" alt="">
                                            <div class="overlay">
                                                <ul>
                                        ...
                                        <div class="single-product-description">
                                            <h5 class="title">
                                                <a href="product-details.php?id=<?php echo $rowDo['id']; ?>">
                                                    <?php echo $rowDo['name']; ?>
                                                </a>
                                            </h5>
                                            <div class="price-box">
